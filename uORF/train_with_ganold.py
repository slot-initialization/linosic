...
if __name__ == '__main__':
    ...
    opt.n_scenes = opt.n_val_scenes
    val_dataset = create_dataset(opt)
    opt.dataroot = dataroot
    opt.n_scenes = n_scenes
    ...
    for epoch in range(opt.epoch_count, opt.niter + opt.niter_decay + 2):    # outer loop for different epochs; we save the model by <epoch_count>, <epoch_count>+<save_latest_freq>
